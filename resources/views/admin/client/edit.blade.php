    ...
    <div class="col-xl-12">
      <div class="card mb-6">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <small class="text-body float-end">Update client details</small>
        </div>
        <div class="card-body">
          ...
          <form action="{{ route('admin.client.update', $client->id) }}" method="POST">
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" id="relationship_with_patient" name="relationship_with_patient" class="form-control @error('relationship_with_patient') is-invalid @enderror" value="{{ old('relationship_with_patient', $client->relationship_with_patient) }}" />
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" id="mobile_number" name="mobile_number" class="form-control @error('mobile_number') is-invalid @enderror" value="{{ old('mobile_number', $client->mobile_number) }}" />
                  <label for="mobile_number">Mobile Number<span class="text-danger fw-bolder">*</span></label>
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $client->email) }}" />
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" id="emergency_contact_mobile_number" name="emergency_contact_mobile_number" class="form-control @error('emergency_contact_mobile_number') is-invalid @enderror" value="{{ old('emergency_contact_mobile_number', $client->emergency_contact_mobile_number) }}" />
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" id="emergency_contact_name" name="emergency_contact_name" class="form-control @error('emergency_contact_name') is-invalid @enderror" value="{{ old('emergency_contact_name', $client->emergency_contact_name) }}" />
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" id="alternate_mobile_number" name="alternate_mobile_number" class="form-control @error('alternate_mobile_number') is-invalid @enderror" value="{{ old('alternate_mobile_number', $client->alternate_mobile_number) }}" />
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" id="gst_no" name="gst_no" class="form-control @error('gst_no') is-invalid @enderror" value="{{ old('gst_no', $client->gst_no) }}" />
                ...
                <div class="form-floating">
                  <select id="id_type" name="id_type" class="form-select @error('id_type') is-invalid @enderror">
                    @foreach(\App\Models\Client::getIdTypes() as $key => $label)
                      <option value="{{ $key }}" {{ old('id_type', $client->id_type) == $key ? 'selected' : '' }}>
                        {{ $label }}
                      </option>
                    @endforeach
                  </select>
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" id="id_number" name="id_number" class="form-control @error('id_number') is-invalid @enderror" value="{{ old('id_number', $client->id_number) }}" />
              ...
              <div class="col-md-12">
                <div class="form-floating">
                  <input class="form-control" type="text" id="address" name="address" value="{{ old('address', $client->address) }}" />
              ...
              <div class="col-md-6">
                <div class="form-floating">
                  <select id="state" class="form-select select2" name="state">
