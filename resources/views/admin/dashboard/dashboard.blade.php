  ...
  <div class="col-md-12 col-lg-4">
    <div class="card">
      <div class="card-body text-nowrap">
        ...
        <p class="mb-2">Will Add Soon</p>
        <h4 class="text-primary mb-0">NAN</h4>
        <p class="mb-2">NAN 🚀</p>
...
{{--          </div>--}}
        ...
        <p class="small mb-0">New Client<span class="h6 mb-0"> {{$clientsThisMonth}}</span> 😎 this month</p>
      </div>
